...
class NnsRosBridge_v2
{
public:
  NnsRosBridge_v2 (const char *node_name, const char *topic_name);
...
void *nns_ros_bridge_init_v2 (const char *node_name, const char *topic_name);
gboolean nns_ros_bridge_publish_v2 (void *instance, const guint num_tensors,
    const GstTensorMemory *tensors_mem);
gboolean nns_ros_bridge_set_pub_topic_v2 (void *instance,
