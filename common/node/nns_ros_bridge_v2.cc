 ...
 * @return None
 */
NnsRosBridge_v2::NnsRosBridge_v2 (const char *node_name, const char *topic_name)
{
 ...
 */
gboolean NnsRosBridge_v2::setPubTopicInfo (const GstTensorsConfig *conf)
{
 ...
 * @return TRUE if the configuration is successfully done
 */
gboolean NnsRosBridge_v2::publish (const guint num_tensors,
 ...
 * uses this class should be holding the instance of NnsRosBridge_v2 (i.e., the
 * void type pointer what the nns_ros_bridge_init() function returns).
 */
void *
nns_ros_bridge_init_v2 (const char *node_name, const char *topic_name)
{
  return new NnsRosBridge_v2 (node_name, topic_name);
}

gboolean
nns_ros_bridge_publish_v2 (void *instance, const guint num_tensors,
    const GstTensorMemory *tensors_mem)
{
  NnsRosBridge_v2 *nrb_instance = (NnsRosBridge_v2 *) instance;

  return nrb_instance->publish (num_tensors, tensors_mem);
}

gboolean
nns_ros_bridge_set_pub_topic_v2 (void *instance, const GstTensorsConfig *conf)
{
  NnsRosBridge_v2 *nrb_instance = (NnsRosBridge_v2 *) instance;
